...
class ProductDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BaseView<ProductDetailViewModel>(
      onModelReady: (m)=> m.init(property),
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: PageView.builder(
                                ...
                                itemCount: model.property?.images.length,
                                itemBuilder: (_, _i){
                                  return Hero(
                                    tag: model.property?.images[_i]??"",
                                    child: Container(
                                      height: height(context),
                                      width: width(context),
                                      decoration: BoxDecoration(
                                        image: DecorationImage(
                                          image: CachedNetworkImageProvider(model.property?.images[_i]??""),
                                          fit: BoxFit.cover
                                        )
                                      ),
                                    ),
                            ...
                            Align(
                              ...
                              child: Padding(
                                padding:16.sp.padA,
                                child: DotIndicators(
                                  total: model.property?.images.length??0,
